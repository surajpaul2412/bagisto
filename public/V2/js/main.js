    ...
    return e.prototype.init = function (e) {
            ...
            a.$wrapper = e, a.isQuickview = !!e.closest(".mfp-content").length, a._isPgvertical = !1, a.isQuickview && (n = n.bind(this), Riode.ratingTooltip()), s.on("initialized.owl.carousel", function (e) {
                    a.isQuickview || s.append('<a href="#" class="product-image-full"><i class="d-icon-zoom"></i></a>'),
                        function (e) {
                            e.$thumbs = e.$wrapper.find(".product-thumbs"), e.$thumbsWrap = e.$thumbs.parent(), e.$thumbUp = e.$thumbsWrap.find(".thumb-up"), e.$thumbDown = e.$thumbsWrap.find(".thumb-down"), e.$thumbsDots = e.$thumbs.children(), e.thumbsCount = e.$thumbsDots.length, e.$productThumb = e.$thumbsDots.eq(0), e._isPgvertical = e.$thumbsWrap.parent().hasClass("pg-vertical"), e.thumbsIsVertical = e._isPgvertical && window.innerWidth >= Riode.minDesktopWidth, e.$thumbDown.hover(function(i) {
                                e.thumbsIsVertical && t(e)
                            }), e.$thumbUp.hover(function(t) {
                                e.thumbsIsVertical && i(e)
                            }), e.$thumbsDots.hover(function() {
                                var t = $(this),
...
// Coupon Toggle btn
$("#aplyTbtn").click(function(){  
    //$(".cart-coupon-box").show()
    $(".cart-coupon-box").toggleClass("block"); 
}); 